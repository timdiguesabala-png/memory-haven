...
export default function Arbre() {
  ...
  const styles = {
    ...
    noeud: { background: darkMode ? '#1E1A16' : '#FFF9F3', border: `1px solid ${darkMode ? '#C8956C' : '#E8C9A0'}`, borderRadius: '12px', padding: '12px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', minWidth: '160px', marginBottom: '4px' },
    ...
    fichePopup: { background: darkMode ? '#1E1A16' : '#FFF', border: `1px solid ${darkMode ? '#C8956C' : '#E8C9A0'}`, borderRadius: '12px', padding: '12px', marginBottom: '8px', minWidth: '200px', boxShadow: '0 4px 16px rgba(0,0,0,0.15)' },
    ...
    ligneVerticale: { width: '2px', height: '30px', background: darkMode ? '#C8956C' : '#E8C9A0' },
