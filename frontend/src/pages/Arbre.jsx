...
export default function Arbre() {
  ...
  const styles = {
    ...
    noeud: { background: darkMode ? '#1A1828' : '#D0C2E4', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '12px', padding: '12px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', minWidth: '160px', marginBottom: '4px' },
