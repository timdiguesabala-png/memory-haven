...
export default function Arbre() {
  ...
  const styles = {
    ...
    statCard: { background: darkMode ? '#1A1828' : '#FFF9F3', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '8px', padding: '10px', marginBottom: '6px', textAlign: 'center' },
    ...
    formCard: { background: darkMode ? '#221F32' : '#FFF9F3', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '12px', padding: '1.25rem', marginBottom: '1.5rem' },
    ...
    input: { width: '100%', padding: '8px 12px', borderRadius: '8px', border: `1.5px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, fontSize: '13px', background: darkMode ? '#2A2218' : '#B8A8CC', color: darkMode ? '#e0e0e0' : '#2A2640', outline: 'none', boxSizing: 'border-box' },
    ...
    noeud: { background: darkMode ? '#1A1828' : '#FFF9F3', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '12px', padding: '12px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', minWidth: '160px', marginBottom: '4px' },
    ...
    fichePopup: { background: darkMode ? '#1A1828' : '#B8A8CC', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '12px', padding: '12px', marginBottom: '8px', minWidth: '200px', boxShadow: '0 4px 16px rgba(0,0,0,0.15)' },
