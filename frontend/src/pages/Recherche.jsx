...
export default function Recherche() {
  ...
  const styles = {
    ...
    searchBar: { display: 'flex', alignItems: 'center', gap: '10px', background: darkMode ? '#16213e' : '#D0C2E4', border: `1px solid ${darkMode ? '#e94560' : '#C5B8E0'}`, borderRadius: '12px', padding: '8px 16px', marginBottom: '1rem' },
    ...
    filterSelect: { padding: '8px 12px', borderRadius: '8px', border: `1px solid ${darkMode ? '#e94560' : '#C5B8E0'}`, background: darkMode ? '#16213e' : '#D0C2E4', color: darkMode ? '#e0e0e0' : '#2A2640', fontSize: '13px' },
    btnReset: { background: 'none', border: 'none', color: '#5B4D9E', cursor: 'pointer', fontSize: '13px', textDecoration: 'underline', padding: '8px 12px' },
    resultInfo: { background: darkMode ? '#221F32' : '#C8B8DC', padding: '10px 16px', borderRadius: '8px', marginBottom: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
