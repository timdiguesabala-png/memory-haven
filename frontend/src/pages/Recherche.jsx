...
export default function Recherche() {
  ...
  const styles = {
    ...
    searchBar: { display: 'flex', alignItems: 'center', gap: '10px', background: darkMode ? '#16213e' : '#FFF9F3', border: `1px solid ${darkMode ? '#e94560' : '#C5B8E0'}`, borderRadius: '12px', padding: '8px 16px', marginBottom: '1rem' },
    ...
    filterSelect: { padding: '8px 12px', borderRadius: '8px', border: `1px solid ${darkMode ? '#e94560' : '#C5B8E0'}`, background: darkMode ? '#16213e' : '#FFF9F3', color: darkMode ? '#e0e0e0' : '#2A2640', fontSize: '13px' },
