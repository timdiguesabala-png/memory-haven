...
export default function Membres() {
  ...
  const styles = {
    ...
    membreCard: { background: darkMode ? '#1A1828' : '#FFF9F3', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, borderRadius: '12px', padding: '1rem', display: 'flex', alignItems: 'flex-start', gap: '12px' },
    ...
    selectRole: { padding: '5px 8px', borderRadius: '8px', border: `1px solid ${darkMode ? '#7B6BB8' : '#C5B8E0'}`, fontSize: '12px', background: darkMode ? '#2A2218' : '#B8A8CC', color: darkMode ? '#e0e0e0' : '#2A2640', cursor: 'pointer' },
